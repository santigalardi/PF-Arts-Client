...
const UserDetail = () => {
	...
	const validArtworks = Array.isArray(filteredArtworks) ? filteredArtworks : [];

	// Necesita 4 obras para completar el carrusel:
	const artworksNeeded = 4 - validArtworks.length;

	// Si no completa, agrega imágenes en color gris:
	...
	// Combina las obras del usuario con las imágenes en gris si es necesario:
	const combinedArtworks = [...validArtworks, ...grayImages];
