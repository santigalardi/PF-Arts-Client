  ...
  return (
    <div className={style['containerUserDetail']}>
      <div className={style['userDetail']}>
        <div className={style['positionPhoto']}>{selectedFile ? <img src={selectedFile} alt='img' className={style['photoPerfil']} /> : userDetail?.profilePicture && <img src={userDetail.profilePicture} alt='img' className={style['photoPerfil']} />}</div>
