...
const UserDetail = () => {
  ...
  const imagesDefault = ['https://www.bicaalu.com/wp-content/uploads/el_tarot_de_leonora_carrington.jpg', 'https://www.feelcats.com/wp-content/uploads/2014/11/Henrietta-Ronner_cuadro_011.jpg', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPU0TPyuimzbBY8WaUq-5AUqAd4ONhQTUd7g&usqp=CAU', 'https://i0.wp.com/hotbook.mx/wp-content/uploads/2014/10/hotbook-94.jpg?fit=1024%2C768&ssl=1', 'https://i0.wp.com/arteyalgomas.com/wp-content/uploads/2020/01/Van_Gogh.-Campo-de-trigo-con-cuervos.-1890.jpg?resize=1140%2C713&ssl=1', 'https://i.pinimg.com/originals/fd/65/c5/fd65c5b4d77549893ee645706e30605c.jpg'];
  ...
  return (
    <div className={style.containerUserDetail}>
      ...
      <div className={style.userDetail}>
        ...
        {userDetail?.profilePicture && <img src={userDetail.profilePicture} alt='img' className={style['photoPerfil']} />}
      </div>
